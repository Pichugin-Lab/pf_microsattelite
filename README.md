# pf_microsattelite
Repository for *P. falciparum* microsatellite analysis.

This README is a full repository tour and step-by-step guide to reproducing all analyses and figures produced by `microsattelite.qmd`.
